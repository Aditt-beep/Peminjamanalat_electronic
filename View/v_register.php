...
<div class="page">
  ...
  <main>
    ...
    <div class="left">
      ...
      <h1>
        <span class="l1">Buat akun</span>
        <span class="l2">untuk mulai.</span>
      </h1>
    ...
    <form
      class="card"
      method="POST"
      action="../controller/c_register.php"
    >

      <h2>Buat akun baru</h2>

      <p class="subtitle">
        Daftar untuk mulai meminjam alat.
      </p>
