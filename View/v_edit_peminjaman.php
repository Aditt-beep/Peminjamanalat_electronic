...
if (!isset($_GET['id'])) {
    header("Location: v_peminjaman.php");
    exit;
}
...
<head>
    ...
    <title>pinjam.in — Edit Peminjaman</title>
        ...
        <div class="panel">
            ...
            >
                ...
                <input
                    type="hidden"
                    name="id_peminjaman"
                    value="<?= htmlspecialchars($peminjaman['id_peminjaman'] ?? '') ?>"
                >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($peminjaman['tanggal_pengajuan'] ?? '') ?>"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($peminjaman['tanggal_peminjaman'] ?? '') ?>"
                            required
                        >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($peminjaman['tanggal_kembali_rencana'] ?? '') ?>"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option
                                value="disetujui"
                                <?= (($peminjaman['status'] ?? '') == 'disetujui') ? 'selected' : '' ?>
                            >
                                Disetujui
                            </option>
